      ...
      >
        ...
        <div className="flex items-center justify-center gap-4 mb-8 md:gap-6 md:w-1/2 md:mb-0">
          <div className="flex flex-col gap-4 md:gap-6">
            <img
              className="object-cover w-48 h-48 rounded-lg shadow-lg md:w-60 md:h-60"
              src={about1}
              alt="about picture 1"
            />
            <img
          ...
          <img
            className="object-cover w-48 h-48 ml-4 rounded-lg shadow-lg md:w-60 md:h-60 md:ml-6"
            src={about2}
            alt="about picture 2"
          />
        </div>
