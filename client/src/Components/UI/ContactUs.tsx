        ...
        <section className="py-20 mx-auto bg-no-repeat bg-cover bg-heroBg">
          <div className="container px-5 mx-auto">
            <p className="py-5 font-semibold"> <Link to={"/"} className="hover:underline decoration-bgText"> Home</Link> /
              <Link className="hover:underline decoration-bgText" to={"/contact"}> Signup </Link>
            </p>

            <h2 className="pt-5 text-3xl font-bold"> Create Account </h2>
            <p className="pb-5 lg:w-1/2">Want to get started by signing up?</p>
          </div>
      ...
      <section className={`bg-no-repeat bg-cover ${location.pathname === "/contact" ? "bg-none" : "bg-heroBg"}`}>
        <div className="container flex flex-col items-center justify-center py-12 mx-auto md:flex-row md:gap-28 lg:gap-52 ">
          ...
          <div className="flex flex-col w-full px-5 mt-8 md:px-0 md:w-1/3">
            {
              location.pathname != "/contact" && <h2 className="mb-1 text-2xl font-bold ">Create Account</h2>
            }

            <p className="mb-5 text-gray-600">Want to get started by signing up?</p>
            ...
            <div className="relative mb-4">
              <label htmlFor="password" className="text-sm leading-7 text-gray-600">Password </label>
            ...
            <div className="relative mb-4">
              <label htmlFor="confirm_password" className="text-sm leading-7 text-gray-600">Confirm Password </label>
              <input type="confirm_password" id="confirm_password" name="confirm_password" className="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-white border border-gray-300 rounded outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200" />
            </div>
